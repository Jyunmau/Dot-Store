...
class EventService:
    ...
    EVENT_CATEGORY_MAP = {
        ...
        EventType.CUSTOMER_ACCOUNT_CREATED: EventCategory.CUSTOMER,
        EventType.CUSTOMER_ACCOUNT_UPDATED: EventCategory.CUSTOMER,
        EventType.CASH_INCOME: EventCategory.CASH,
        EventType.CASH_EXPENSE: EventCategory.CASH,
        EventType.CASH_ACCOUNT_CREATED: EventCategory.CASH,
        EventType.CASH_ACCOUNT_UPDATED: EventCategory.CASH,
        EventType.FINANCIAL_SNAPSHOT_CREATED: EventCategory.FINANCE,
        EventType.EXPENSE_CREATE: EventCategory.FINANCE,
        EventType.EXPENSE_UPDATE: EventCategory.FINANCE,
        EventType.EXPENSE_DELETE: EventCategory.FINANCE,
